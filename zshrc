### zshrc - modified for use with powerlevel9k

### This file is NOT meant to be used with the peyote or mescaline
### prompt builders(!).
...
# source environment setup file (if present)
if [ -f $HOME/.env ]; then
  source $HOME/.env
fi

# change somoe powerlevel9k colours
export POWERLEVEL9K_TIME_BACKGROUND='239'
export POWERLEVEL9K_TIME_FOREGROUND='white'

# finally, source the powerlevel9k rc file
source $HOME/git/powerlevel9k/powerlevel9k.zsh-theme
